...
class TestGrahamScan1(unittest.TestCase):
    ...
    def test_graham(self):
        algorithm = GrahamScan(self.point_list)
        algorithm.run()
...
class TestGrahamScan2(unittest.TestCase):
...
class TestGrahamScan3(unittest.TestCase):
...
class TestGrahamScan4(unittest.TestCase):
...
class TestGrahamScan5(unittest.TestCase):
