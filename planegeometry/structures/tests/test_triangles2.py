...
from planegeometry.structures.triangles2 import Triangle

class TestTriangle(unittest.TestCase):

    def setUp(self):
        self.t1 = Triangle(Point(0, 0), Point(6, 0), Point(0, 12))
        self.t2 = Triangle(Point(3, 0), Point(9, 0), Point(6, 6))
        self.t3 = Triangle(Point(0, 0), Point(2, 0), Point(1, 2))
        self.t4 = Triangle(Point(Fraction(1, 2), Fraction(2, 3)),
            Point(Fraction(3, 4), Fraction(4, 5)),
            Point(Fraction(5, 6), Fraction(6, 7)))

    def test_init(self):
        self.assertRaises(TypeError, Triangle, 0, 0, 1, 1, 3, 3)
        self.assertRaises(TypeError, Triangle, 0, 0, 1, 1, 3)
        self.assertRaises(TypeError, Triangle, 0, 0, 1, 1)
    ...
    def test_print(self):
        ...
        "Triangle(Point(0, 0), Point(6, 0), Point(0, 12))")
        self.assertEqual(repr(self.t2),
        "Triangle(Point(3, 0), Point(9, 0), Point(6, 6))")
        self.assertEqual(repr(self.t3),
        "Triangle(Point(0, 0), Point(2, 0), Point(1, 2))")
        self.assertEqual(repr(self.t4), 
        "Triangle(Point(Fraction(1, 2), Fraction(2, 3)), Point(Fraction(3, 4), Fraction(4, 5)), Point(Fraction(5, 6), Fraction(6, 7)))")

    def test_cmp(self):
        self.assertTrue(self.t1 == Triangle(Point(0, 0), Point(6, 0), Point(0, 12)))
        self.assertFalse(self.t1 == self.t2)
        self.assertTrue(self.t1 != self.t2)
        self.assertFalse(self.t1 != Triangle(Point(0, 0), Point(6, 0), Point(0, 12)))
    ...
    def test_move(self):
        self.assertEqual(self.t1.move(1, 2),
        Triangle(Point(1, 2), Point(7, 2), Point(1, 14)))
        self.assertEqual(self.t1.move(Point(1, 2)),
        Triangle(Point(1, 2), Point(7, 2), Point(1, 14)))
        self.assertRaises(ValueError, Triangle.move, self.t1, 1)

    def test_make3(self):
        t1 = Triangle(Point(0, 0), Point(6, 0), Point(2, 4))
        t2 = Triangle(Point(6, 0), Point(0, 12), Point(2, 4))
        t3 = Triangle(Point(0, 12), Point(0, 0), Point(2, 4))
    ...
    def test_make4(self):
        t1 = Triangle(Point(0, 0), Point(3, 0), Point(0, 6))
        t2 = Triangle(Point(6, 0), Point(3, 6), Point(3, 0))
        t3 = Triangle(Point(0, 12), Point(0, 6), Point(3, 6))
        t4 = Triangle(Point(3, 0), Point(3, 6), Point(0, 6))
    ...
    def test_contains(self):
        ...
        # segment in tringle
        self.assertTrue(Segment(Point(1, 1), Point(2, 2)) in self.t1)
        self.assertFalse(Segment(Point(1, 1), Point(6, 6)) in self.t1)

    def test_orientation(self):
        self.assertEqual(self.t1.orientation(), 1)
        self.assertEqual(Triangle(Point(0, 0), Point(1, 1), Point(1, 0)).orientation(), -1)
    ...
    def test_itersegments(self):
        ...
        self.assertTrue(Segment(Point(0, 0), Point(6, 0)) in L)
        self.assertTrue(Segment(Point(0, 0), Point(0, 12)) in L)
        self.assertTrue(Segment(Point(0, 12), Point(6, 0)) in L)

    def test_itersegments_oriented(self):
        L = list(self.t1.itersegments_oriented())
        self.assertTrue(Segment(Point(6, 0), Point(0, 0)) in L)
        self.assertTrue(Segment(Point(0, 0), Point(0, 12)) in L)
        self.assertTrue(Segment(Point(0, 12), Point(6, 0)) in L)
