...
class TestSegment(unittest.TestCase):
    ...
    def setUp(self):
        self.segment1 = Segment(Point(0, 0), Point(2, 0))
        self.segment2 = Segment(Point(0, 0), Point(1, 1))
        self.segment3 = Segment(Point(Fraction(1, 2), Fraction(2, 3)),
            Point(Fraction(3, 4), Fraction(4, 5)))

    def test_init(self):
        self.assertRaises(ValueError, Segment, 0, 1)
        self.assertRaises(TypeError, Segment, 0, 1, 2)
        self.assertRaises(ValueError, Segment, Point(0, 1), 2)
        self.assertRaises(ValueError, Segment, 2, Point(0, 1))
        self.assertRaises(TypeError, Segment, 0, 1, 0, 1)
        self.assertRaises(ValueError, Segment, Point(0, 1), Point(0, 1))

    def test_print(self):
        self.assertEqual(repr(self.segment1), "Segment(Point(0, 0), Point(2, 0))")
        self.assertEqual(repr(self.segment2), "Segment(Point(0, 0), Point(1, 1))")
        self.assertEqual(repr(self.segment3),
        "Segment(Point(Fraction(1, 2), Fraction(2, 3)), Point(Fraction(3, 4), Fraction(4, 5)))")

    def test_cmp(self):
        self.assertTrue(self.segment1 == Segment(Point(0, 0), Point(2, 0)))
        self.assertFalse(self.segment1 == self.segment2)
        self.assertTrue(self.segment1 != self.segment2)
        self.assertFalse(self.segment1 != Segment(Point(0, 0), Point(2, 0)))
    ...
    def test_move(self):
        self.assertEqual(self.segment1.move(1, 2),
            Segment(Point(1, 2), Point(3, 2)))
        self.assertEqual(self.segment1.move(Point(1, 2)),
            Segment(Point(1, 2), Point(3, 2)))
        self.assertRaises(ValueError, Segment.move, self.segment1, 1)

    def test_invert(self):
        self.assertEqual(~self.segment1, Segment(Point(2, 0), Point(0, 0)))
        self.assertEqual(~self.segment2, Segment(Point(1, 1), Point(0, 0)))
    ...
    def test_contains(self):
        ...
        self.assertTrue(Segment(Point(0, 0), Point(1, 0)) in self.segment1)
        self.assertFalse(self.segment2 in self.segment1)

    def test_intersect(self):
        self.assertTrue(self.segment1.intersect(self.segment2))
        self.assertTrue(self.segment1.intersect(Segment(Point(1, -1), Point(1, 1)))) # -|-
        self.assertTrue(self.segment1.intersect(Segment(Point(1, 0), Point(3, 0)))) # zachodza
        self.assertTrue(self.segment1.intersect(Segment(Point(-1, 0), Point(3, 0)))) # 1 w 2
        self.assertFalse(self.segment1.intersect(Segment(Point(1, 1), Point(3, 3)))) # / -
        self.assertFalse(self.segment1.intersect(Segment(Point(3, -1), Point(3, 1)))) # - |

    def test_intersection_point(self):
        s1 = Segment(Point(0, 0), Point(3, 3))
        s2 = Segment(Point(1, 3), Point(3, 1))
        s3 = Segment(Point(1, 0), Point(1, 2))
        ...
        self.assertEqual(s1.intersection_point(
            Segment(Point(0, 1), Point(2, 1))), Point(1, 1))
        ...
        self.assertRaises(ValueError, Segment.intersection_point,
            self.segment2, s1)
        self.assertRaises(ValueError, Segment.intersection_point,
            self.segment1, Segment(Point(1, 0), Point(3, 0)))
        self.assertRaises(ValueError, Segment.intersection_point,
            s3, Segment(Point(1, 1), Point(1, 3)))

    def test_parallel(self):
        self.assertTrue(self.segment1.parallel(Segment(Point(1, 1), Point(2, 1))))
        self.assertTrue(self.segment2.parallel(Segment(Point(1, 0), Point(2, 1))))
        self.assertFalse(self.segment1.parallel(self.segment2))

    def test_perpendicular(self):
        self.assertTrue(self.segment1.perpendicular(Segment(Point(1, 0), Point(1, 1))))
        self.assertTrue(self.segment2.perpendicular(Segment(Point(1, 1), Point(2, 0))))
